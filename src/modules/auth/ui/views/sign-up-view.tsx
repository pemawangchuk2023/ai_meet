...
const SignUpView = () => {
	...
	return (
		<div className='flex flex-col gap-6'>
					...
					<Form {...form}>
						<form className='p-6 md:p-8' onSubmit={form.handleSubmit(onSubmit)}>
							<div className='flex flex-col gap-6'>
								...
								'
								>
									<div className='bg-card text-muted-foreground relative z-10 px-2'>
										Or continue with
									</div>
								</div>
			...
			<div className='text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance x:[a]:underline x:[a]:underline-offset-4'>
